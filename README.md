...
| --- | --- | --- | --- | --- |
| Add search/filter to Completed Workflows page | Not Started | Critical | 2 | — |
| Add summary stats header to Completed Workflows | Not Started | High | 2 | — |
| Add sort options to Completed Workflows | Not Started | Medium | 1 | — |
| Add helpful empty states across all major views | Not Started | High | 3 | — |
| Add React error boundaries at feature boundaries | Not Started | High | 3 | — |
| WebSocket auto-reconnection with exponential backoff | Not Started | High | 3 | — |
| Add lightweight CI pipeline (test + lint gates) | Not Started | High | 2 | — |
| Add health check endpoint | Not Started | Medium | 1 | — |
| Fix discussion toolbar formatting buttons | Not Started | Medium | 2 | — |
...
| Knowledge Management API routes | Not Started | High | 3 | — |
| Knowledge Management UI | Not Started | High | 8 | Knowledge Management API routes |
